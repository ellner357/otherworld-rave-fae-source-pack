...
|---|---|---|---|
| 0.3.0 | pending local commit | Start-here guide, canon index, event lore, threshold mechanics, continuity rules | Revert the v0.3.0 commit to return to source-audit state |
