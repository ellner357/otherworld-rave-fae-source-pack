...
|---|---|---|---|
| 0.5.0 | pending local commit | Gemini, NotebookLM, Google Docs export package and mirror links | Revert the v0.5.0 commit to return to character-pack state; manually archive/delete created Google Docs mirrors only if Matt approves |
