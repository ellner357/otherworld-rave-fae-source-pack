...
|---|---|---|---|
| 0.4.0 | pending local commit | Character bible, voice guide, archetypes, diagnostics, safety, motifs, examples | Revert the v0.4.0 commit to return to canon-spine state |
